function [xs_est,acceptance_rate]=Metropolis_multiClass_GMM009(x_measured, mu_SAEM, Sigma_SAEM,weights_SAEM, beta_SAEM,x_mean_imputation, nb_Sample_mcmc,  n, y,z)
     ...
     g                          = @(x)  densiteMelangeGaussien(x, means, covariances, p);
       ...
       switch y(i)
        ...
        case 1
           ...
           exp(beta_SAEM(1,4) + x * beta_SAEM(index_miss_i + 1,4) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,4)) + ...
           exp(beta_SAEM(1,5) + x * beta_SAEM(index_miss_i + 1,5) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,5)) + ...
           exp(beta_SAEM(1,6) + x * beta_SAEM(index_miss_i + 1,6) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,6)) + ...
           exp(beta_SAEM(1,7) + x * beta_SAEM(index_miss_i + 1,7) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,7)) + ...
           exp(beta_SAEM(1,8) + x * beta_SAEM(index_miss_i + 1,8) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,8)))* mvnpdf(x, mu_cond, Sigma_cond)));
        case 2
       ...
       case 3
        ...
        case 5        
                    f=@(x)   ( (  exp(beta_SAEM(1,5)+x*beta_SAEM(index_miss_i+1,5)+ x_s_1(i,index_obs_i)*beta_SAEM(index_obs_i+1,5))...
                    /(1 + exp(beta_SAEM(1,1) + x * beta_SAEM(index_miss_i + 1,1) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,1)) + ...
           exp(beta_SAEM(1,2) + x * beta_SAEM(index_miss_i + 1,2) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,2)) + ...
           exp(beta_SAEM(1,3) + x * beta_SAEM(index_miss_i + 1,3) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,3)) + ...
           exp(beta_SAEM(1,4) + x * beta_SAEM(index_miss_i + 1,4) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,4)) + ...
        ...
        case 6               
                    f=@(x)   ( (  exp(beta_SAEM(1,6)+x*beta_SAEM(index_miss_i+1,6)+ x_s_1(i,index_obs_i)*beta_SAEM(index_obs_i+1,6))...
                    /(1 + exp(beta_SAEM(1,1) + x * beta_SAEM(index_miss_i + 1,1) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,1)) + ...
           exp(beta_SAEM(1,2) + x * beta_SAEM(index_miss_i + 1,2) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,2)) + ...
           exp(beta_SAEM(1,3) + x * beta_SAEM(index_miss_i + 1,3) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,3)) + ...
           exp(beta_SAEM(1,4) + x * beta_SAEM(index_miss_i + 1,4) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,4)) + ...
      ...
      case 7              
                   ...
                   f=@(x)   ( (  exp(beta_SAEM(1,7)+x*beta_SAEM(index_miss_i+1,7)+ x_s_1(i,index_obs_i)*beta_SAEM(index_obs_i+1,7))...
                    /(1 + exp(beta_SAEM(1,1) + x * beta_SAEM(index_miss_i + 1,1) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,1)) + ...
           exp(beta_SAEM(1,2) + x * beta_SAEM(index_miss_i + 1,2) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,2)) + ...
           exp(beta_SAEM(1,3) + x * beta_SAEM(index_miss_i + 1,3) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,3)) + ...
           exp(beta_SAEM(1,4) + x * beta_SAEM(index_miss_i + 1,4) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,4)) + ...
       ...
       case 8             
                   ...
                   f=@(x)   ( (  exp(beta_SAEM(1,8)+x*beta_SAEM(index_miss_i+1,8)+ x_s_1(i,index_obs_i)*beta_SAEM(index_obs_i+1,8))...
                    /(1 + exp(beta_SAEM(1,1) + x * beta_SAEM(index_miss_i + 1,1) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,1)) + ...
           exp(beta_SAEM(1,2) + x * beta_SAEM(index_miss_i + 1,2) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,2)) + ...
           exp(beta_SAEM(1,3) + x * beta_SAEM(index_miss_i + 1,3) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,3)) + ...
           exp(beta_SAEM(1,4) + x * beta_SAEM(index_miss_i + 1,4) + x_s_1(i,index_obs_i) * beta_SAEM(index_obs_i + 1,4)) + ...
