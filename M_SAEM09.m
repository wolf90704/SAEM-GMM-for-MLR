function [ beta_estimated_SAEM,w_SAEM,mu_SAEM,Sigma_SAEM,stats_saem] = M_SAEM09(X,y,num_components)
p = size(X,2);
n = size(X,1);
...
for iter=1:Iter_EM
  ...
  % [x_s,acceptance_rate]=Metropolis_multiClass_GMM05(X, mu_SAEM, Sigma_SAEM,w_SAEM, beta_estimated_SAEM, nb_Sample_MHS,  n, y);
    [x_s,acceptance_rate] = Metropolis_multiClass_GMM009(X, mu_SAEM, Sigma_SAEM,w_SAEM, beta_estimated_SAEM, nb_Sample_MHS,  n, y);
